<template>
    ...
    <div v-if="isReady()" id="help-modal" class="modal" tabindex="-1" data-bs-backdrop="static">
      <HelpModal
  ...
  <template v-if="!isReady()">
    <div class="d-flex justify-content-center align-items-center full-height" style="height: 100vh;">
...
<!--          &lt;!&ndash;        <span class="game-badge-icon game-button badge text-bg-warning me-1">&ndash;&gt;-->
<!--          &lt;!&ndash;          <i class="fa-solid fa-reply"></i>&ndash;&gt;-->
<!--          &lt;!&ndash;          {{ context.actions_discard }}&ndash;&gt;-->
<!--          &lt;!&ndash;        </span>&ndash;&gt;-->
...
import ActionsBadge from "@/components/ActionsBadge.vue";
</script>
...
export default {
  ...
  methods: {
    ...
    showHelpModal() {
      let modal = new Modal(document.getElementById("help-modal"), {});
      modal.show();
    },
    closeMessagesModal() {
